...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        ssB = new QPushButton(centralWidget);
        ssB->setObjectName(QStringLiteral("ssB"));

        gridLayout->addWidget(ssB, 2, 0, 1, 1);

        scB = new QPushButton(centralWidget);
        scB->setObjectName(QStringLiteral("scB"));

        gridLayout->addWidget(scB, 2, 1, 1, 1);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        ssB->setText(QApplication::translate("MainWindow", "SHOW STUDENTS", Q_NULLPTR));
        scB->setText(QApplication::translate("MainWindow", "SHOW COURSES", Q_NULLPTR));
    } // retranslateUi
