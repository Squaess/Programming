...
public class mojGraph {
	...
	public void displayInformation()
	{
		...
		for(int i=0; i<edges.size(); i++)
		{
			...
			System.out.println("��cze " + vertex1 + "-" + vertex2 + ": nat�enie pakiet�w " + value + ", przepustowo�c " + edge.getCapacity());
		}
	...
	double getDelay()
	{
		//G = suma element�w macierzy nat�e�
		double G = 0;
